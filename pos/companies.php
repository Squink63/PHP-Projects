...
<div class="backdrop"></div>
    <nav class="navbar">
        <div class="container-fluid">
            <?php if( $user_in_s['role_id'] == 1 || in_array('cc', $selectedPermissions)) : ?>
              <button id="addr" class="navbar-brand text-dark">Add Company</button>
              <?php else : ?>
              <h4 class="text-white">Companies</h4>
            <?php endif ?>
    ...
    <?php
      ...
      $start = 0;
      $row_per_page = 5;
      $statement = $db->query("SELECT * FROM companies");
      ...
      $pages =  ceil($num_of_rows / $row_per_page);
        ...
        $result = $db -> query("SELECT * FROM companies LIMIT $start, $row_per_page");
...
<table class="table table-dark">
        ...
        <?php foreach($users as $user) : ?>
          ...
          <td>
            <div class="btn-group">
                ...
                <?php if( $user_in_s['role_id'] == 1 || in_array('cu', $selectedPermissions)) : ?>
                  <a href="#" class="btn btn-sm btn-success me-3">Edit</a>
                <?php endif ?>

                <?php if( $user_in_s['role_id'] == 1 || in_array('cd', $selectedPermissions)) : ?>
                  <a href="delcompany.php?id=<?= $user['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                <?php endif ?>
            </div>
          </td>
        </tr>
    ...
    <div id="cf" class="container p-3">
      <form action="addcompany.php" method="post" id="fo">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="address" class="form-control" id="colFormLabelSm" required>
                </div>
              </div>


              
              <button class="btn btn-primary w-100 my-4">Add Company</button>
      </form>
    </div>
