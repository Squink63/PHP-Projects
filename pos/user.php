...
<div class="backdrop"></div>
    <nav class="navbar">
        <div class="container-fluid">
            <?php if( $user_in_s['role_id'] == 1 || in_array('uc', $selectedPermissions)) : ?>
              <button id="addr" class="navbar-brand text-dark">Add User</button>
    ...
    <?php
      ...
      $pages =  ceil($num_of_rows / $row_per_page);
        ...
        $result = $db -> query("SELECT * FROM users LIMIT $start, $row_per_page");
          ...
          <?php foreach($users as $user) : ?>
            ...
            <td>
              <div class="btn-group">
                  ...
                  <?php if( $user_in_s['role_id'] == 1 || in_array('uu', $selectedPermissions)) : ?>
                  <a href="#" class="btn btn-sm btn-success me-3">Edit</a>
                <?php endif ?>

                <?php if( $user_in_s['role_id'] == 1 || in_array('ud', $selectedPermissions)) : ?>
                  <a href="deluser.php?id=<?= $user['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                <?php endif ?>
              </div>
            </td>
          </tr>
    ...
    <div id="cf" class="container p-3">
      <form action="adduser.php" method="post" id="fo">
              ...
              <div class="row mb-3">
                <label for="colFormLabelSm" class="col-sm-2 col-form-label">Role</label>
              ...
              <button class="btn btn-primary w-100 my-4">Add User</button>
      </form>
    </div>
